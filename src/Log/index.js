...
module.exports = class Log extends IsoLog {
	...
	setOptions(options: { level?: string, flushAt?: number, flushIntervalSec?: number, appName?: string, appEnv?: string, appKey?: string, userAgent: string, packageVersion: string, packageName: string, metricsUrl: string, metricsEnabled?: boolean, useColors?: boolean }) {
